...
const steps = [
  {
    id: 1,
    title: "Sign Up",
    text: "Create your Callrio.ai account and set up your workspace.",
  },
  {
    id: 2,
    title: "Start a Call",
    text: "Host or join meetings with AI-powered recording.",
  },
  {
    id: 3,
    title: "Transcribe & Summarize",
    text: "Automatic transcription and intelligent meeting summaries.",
  },
  {
    id: 4,
    title: "Review Insights",
    text: "Access analytics, highlights, and share notes instantly.",
  },
];
...
function Step({
  ...
  return (
    ...
    >
      <div
        className={`glass-card p-6 md:w-60 rounded-2xl text-center transition-all duration-300 hover:scale-105 w-full sm:h-[230px]`}
      >
