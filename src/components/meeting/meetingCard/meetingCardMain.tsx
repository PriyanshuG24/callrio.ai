...
const MeetingCardMain = ({ meeting, type }: MeetingCardProps) => {
  ...
  return (
    <div
      className={`glass-card hover:scale-105 transition-all duration-300 ease-in-out h-full flex flex-col ${theme === "light" ? "bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50" : ""}`}
    >
