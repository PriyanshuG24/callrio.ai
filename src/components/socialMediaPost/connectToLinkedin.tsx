...
import {
  isLinkedInConnected,
  removeLinkedInToken,
} from "@/actions/linkedinPostAction/auth";
  ...
  return (
    <div>
      <button
        ...
        className={`${isConnected ? "bg-red-500 text-white" : "bg-blue-500 text-white"} flex items-center gap-2 px-4 py-2 rounded-lg cursor-pointer text-sm border border-gray-500`}
      >
